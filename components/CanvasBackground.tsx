...
export default function CanvasBackground() {
  ...
  useEffect(() => {
    ...
    const themeColors = ["#38bdf8", "#818cf8", "#a78bfa", "#34d399", "#f472b6"];
    const orbsColors = ["#38bdf8", "#a78bfa", "#34d399"];
    const ringsColors = ["#3b82f6", "#8b5cf6", "#10b981"];
    const connColor = "129,140,248";
    const bgColor = "rgba(2, 6, 23, 0.15)";
